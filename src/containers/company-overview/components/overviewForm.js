...
const OverviewForm = ({ data, onNext }) => {
  ...
  const removeName = (indexToRemove) => {
    ...
    formik.setFieldValue('founderNames', updatedFounderNames);
  };
        ...
        <Form onSubmit={formik.handleSubmit} noValidate>
          ...
          <div className="grid-container">
            ...
            <select
              id="st_country"
              name="st_country"
              className={`form-control ${formik.errors.st_country ? "border-danger" : ""}`}
            ...
            >
              ...
              <optgroup label="Other Countries">
                {countries.slice(5).map((country, index) => (
                  <option key={index + 5} value={country}>
                    {country}
                  </option>
                ))}
              </optgroup>
            ...
            <FormFeedback className="d-block">{formik.errors.st_country}</FormFeedback>
          </FormGroup>
