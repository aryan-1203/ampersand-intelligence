                    ...
                    <div className="card">
                      <div className="card-body">
                        <div className="report-heading">
                          <div className="title-section" style={{ display:"flex", justifyContent:"space-between", alignItems:"center", width:"100%"}}>
                            <h2>
                              AI Report <span className="icon">✦</span>
                            </h2>
                            <p style={{ color:"white"}}>Company code</p>
                          </div>
                          <div className="company-code" style={{ display:"flex", justifyContent:"space-between", alignItems:"center", width:"100%"}}>
                          <p style={{marginTop:"20px", color:"var(--Neutrals-500, #879790"}}>Generated by Ampersand Proprietary Algorithm</p>
