...
const OverviewFundingCards = () => {
  ...
  const fetchFormData = async () => {
    try {
      const response = await fetch("http://ai.ampvc.co:2001/submit-all-forms");
  ...
  return (
    <div className="of-grid">
      ...
      <div className="of-card">
        ...
        <p id="report-p">{fundingData.st_currency} {fundingData.st_raised_to_date || "20 Th"}</p>
      </div>
      <div className="of-card">
      ...
      <div className="of-card">
        ...
        <p id="report-p">{fundingData.st_currency} {fundingData.st_capital_requirements || "500 Th"}</p>
      </div>
    </div>
  );
};
